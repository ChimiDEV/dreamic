...
**Dreamic** (Dream + Atmoic) is a utility library designed for functional programming in JavaScript.
The goal is a easy to use api for wokring with so called `Monads`.
Worry not, if you've never heard of them before.
This documentation will include a quick practical introduction as well as some references to other learning sources.  
...
Heavily inspired by `ramdbda`, `lodash/fp` and other libraries, **Dreamic will help you keep your code simple, clean, expressive and pure.**
...
This instance is helpful for some point-free (see below) utility as well, hence the decision to take the name als exported keword.
...
Since this depends on the type of monad you're working with, you'll have to look up the documentation.
